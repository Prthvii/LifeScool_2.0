...
class NewTstShortsPlayerPage13 extends StatefulWidget {
  var highligts;

  NewTstShortsPlayerPage13({this.highligts});

  @override
  _ShortsPlayerPageState createState() => _ShortsPlayerPageState();
}

class _ShortsPlayerPageState extends State<NewTstShortsPlayerPage13> {
  ...
  VideoPlayerController controller11;
  VideoPlayerController controller12;
  VideoPlayerController controller13;
  VideoPlayerController controller14;
  VideoPlayerController controller15;
  VideoPlayerController controller16;
  VideoPlayerController controller17;
  VideoPlayerController controller18;
  VideoPlayerController controller19;
  VideoPlayerController controller20;
  ...
  Controller0(path) async {

   print("paaaath");
   print(path);

   print("linkkkkkkk");
   print(arrList[0]['video_url']);
   controller0 = VideoPlayerController.file(File(path));

   // controller0 =
   //     VideoPlayerController.network(ourUrl);
   print("paaaath2");
...
///
  ...
  Widget feedVideos() {
    ...
    return Stack(
      children: [
        PageView.builder(
    //  physics: checkIntitializing(nowPlaying+1)==true?AlwaysScrollableScrollPhysics():NeverScrollableScrollPhysics(),
